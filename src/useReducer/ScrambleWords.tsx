...
import {
  getInitialState,
  ScrumbleWordsReducer,
} from "./reducer/ScrumbleWordsReducer";
...
export const ScrambleWords = () => {
  const [state, dispatch] = useReducer(ScrumbleWordsReducer, getInitialState());
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // if (guess.trim() === currentWord.trim()) {
